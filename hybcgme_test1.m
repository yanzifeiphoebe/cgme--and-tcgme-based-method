...
% accuracy2D = {'mri' maxit delta a_mtrsvd b_mtrsvd};
% xlswrite( 'C:\Users\phoebe_yang\Desktop\accuracy2D.xlsx', accuracy2D,'A32:E32')
% 
% time2D = {'mri' maxit delta t4};
% xlswrite( 'C:\Users\phoebe_yang\Desktop\time2D.xlsx',time2D, 'A32:D32');
% % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% figure;
