function [X,V,U,B] = yangcgme(A,b,k,reorth)
%CGME_B Solution of least squares problems by Lanczos bidiagonalization.
%
% [X,rho,eta] = yangcgme_b(A,b,k,reorth,s)
%
% Performs k steps of the CGME Lanczos bidiagonalization algorithm
